...
function newPerson(name: string, age: number, hobby?: string) {
	const p = {
		name,
		age,
...
const susi = newPerson("Susi", 32); // Hier fehlt(e) die Altersangabe
...
if (klaus.spendTimeWithHobby) { // spendTimeWithHobby ist optional
